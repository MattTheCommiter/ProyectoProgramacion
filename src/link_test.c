...
#define MAX_TESTS 36 /*!<Defines de total ammount of test functions*/

/**
 * @brief in this function all test can be executated
 *
 * @param argc
 * @param argv
 * @return int
...
int main(int argc, char *argv[])
{
    ...
    if (all || test == 3)
        test03_link_create();
    if (all || test == 4)
        test01_link_set_origin_id();
    if (all || test == 5)
        test02_link_set_origin_id();
    if (all || test == 6)
        test03_link_set_origin_id();
    if (all || test == 7)
        test04_link_set_origin_id();
    if (all || test == 8)
        test01_link_set_destination_id();
    if (all || test == 9)
        test02_link_set_destination_id();
    if (all || test == 10)
        test03_link_set_destination_id();
    if (all || test == 11)
        test04_link_set_destination_id();
    if (all || test == 12)
        test01_link_set_direction();
    if (all || test == 13)
        test02_link_set_direction();
    if (all || test == 14)
        test03_link_set_direction();
    if (all || test == 15)
        test04_link_set_direction();
    if (all || test == 16)
        test01_link_set_is_open();
    if (all || test == 17)
        test02_link_set_is_open();
    if (all || test == 18)
        test03_link_set_is_open();
    if (all || test == 19)
        test04_link_set_is_open();
    if (all || test == 20)
        test05_link_set_is_open();
    if (all || test == 21)
        test01_link_set_name();
    if (all || test == 22)
        test02_link_set_name();
    if (all || test == 23)
        test03_link_set_name();
    if (all || test == 24)
        test04_link_set_name();
    if (all || test == 25)
        test01_link_get_is_open();
    if (all || test == 26)
        test02_link_get_is_open();
    if (all || test == 27)
        test01_link_get_direction();
    if (all || test == 28)
        test02_link_get_direction();
    if (all || test == 29)
        test01_link_get_id();
    if (all || test == 30)
        test02_link_get_id();
    if (all || test == 31)
        test01_link_get_origin_id();
    if (all || test == 32)
        test02_link_get_origin_id();
    if (all || test == 33)
        test01_link_get_destination_id();
    if (all || test == 34)
        test02_link_get_destination_id();
    if (all || test == 35)
        test01_link_get_name();
    if (all || test == 36)
        test02_link_get_name();
