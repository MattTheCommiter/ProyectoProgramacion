 ...
 */
 ...
 int main(int argc, char **argv) {
     ...
     if (all || test == 2) test1_object_destroy();
     ...
     if (all || test == 7) test1_object_print();
     if (all || test == 8) test1_object_set_description();
     if (all || test == 9) test1_object_get_description();

     if (all || test == 10) test2_object_create();
     if (all || test == 11) test2_object_destroy();
     if (all || test == 12) test2_object_get_id();
     if (all || test == 13) test2_object_set_id();
     if (all || test == 14) test2_object_get_name();
     if (all || test == 15) test2_object_set_name();
     if (all || test == 16) test2_object_print();
     if (all || test == 17) test2_object_set_description();
...
void test2_object_set_description_null() {
    Object *o = object_create(1);
