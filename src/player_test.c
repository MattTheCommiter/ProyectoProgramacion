 ...
 */
 ...
 #include "../include/player.h"
  ...
  int main(int argc, char** argv) {
    ...
    if (all || test == 4) test1_player_set_id() ;
    if (all || test == 5) test2_player_set_id() ;
    if (all || test == 6) test3_player_set_id() ;
    ...
    if (all || test == 11) test1_player_backpack_is_full();
    if (all || test == 12) test2_player_backpack_is_full();
    if (all || test == 13) test3_player_backpack_is_full();
    if (all || test == 14) test1_player_backpack_is_empty();
    if (all || test == 15) test2_player_backpack_is_empty();
    if (all || test == 16) test3_player_backpack_is_empty();
    if (all || test == 17) test1_player_add_object_to_backpack();
    if (all || test == 18) test2_player_add_object_to_backpack();
    if (all || test == 19) test3_player_add_object_to_backpack();
    if (all || test == 20) test1_player_remove_object_from_backpack();
    if (all || test == 21) test2_player_remove_object_from_backpack();
    if (all || test == 22) test3_player_remove_object_from_backpack();
    if (all || test == 23) test1_player_get_num_objects_in_backpack();
    if (all || test == 24) test2_player_get_num_objects_in_backpack();
    if (all || test == 25) test1_player_get_backpack_object_id_at();
    if (all || test == 26) test2_player_get_backpack_object_id_at();
    if (all || test == 27) test3_player_get_backpack_object_id_at();
    if (all || test == 28) test1_player_backpack_contains();
    if (all || test == 29) test2_player_backpack_contains();
    if (all || test == 30) test3_player_backpack_contains();
    ...
    if (all || test == 36) test3_player_get_location();
    if (all || test == 37) test1_player_set_health();
    if (all || test == 38) test2_player_set_health();
    if (all || test == 39) test3_player_set_health();
    if (all || test == 40) test1_player_get_health();
    if (all || test == 41) test2_player_get_health();
    if (all || test == 42) test3_player_get_health();
...
void test1_player_create() {
    ...
    if (player != NULL) {
        ...
        PRINT_TEST_RESULT(inventory_get_max_objs(player_get_backpack(player)) == 10);
