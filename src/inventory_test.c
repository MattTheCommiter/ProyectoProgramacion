...
int main(int argc, char **argv)
{
    ...
    if (all || test == 3)
        test3_inventory_create();
    if (all || test == 4)
        test1_inventory_get_objs();
    if (all || test == 5)
        test2_inventory_get_objs();
    if (all || test == 6)
    ...
    if (all || test == 9)
        test1_inventory_contains();
    if (all || test == 10)
        test2_inventory_contains();
    if (all || test == 11)
        test3_inventory_contains();
    if (all || test == 12)
        test1_inventory_set_objs();
    if (all || test == 13)
        test2_inventory_set_objs();
    if (all || test == 14)
        test3_inventory_set_objs();
    if (all || test == 15)
    ...
    if (all || test == 24)
        test1_inventory_get_object_id_at();
    if (all || test == 25)
        test2_inventory_get_object_id_at();
    if (all || test == 26)
        test3_inventory_get_object_id_at();
    if (all || test == 27)
        test1_inventory_add_object_id();
    if (all || test == 28)
        test2_inventory_add_object_id();
    if (all || test == 29)
        test3_inventory_add_object_id();
    if (all || test == 30)
        test1_inventory_del_object_id();
    if (all || test == 31)
        test2_inventory_del_object_id();
    if (all || test == 32)
        test3_inventory_del_object_id();
