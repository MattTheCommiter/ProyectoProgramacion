...
#define GENERATOR_SPACE 15           /*!< ID of the space where the generator is located during the game */
#define GENERATOR_FLASH_SPACE 150    /*!< ID of the space where the generator is located during the game's alice flashback */
