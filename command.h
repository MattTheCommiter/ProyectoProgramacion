...
typedef enum
{
    ...
    TAKE_S,         /*!<Assigs 4 to the keyword "TAKE_S", which represents taking the seed object*/
    TAKE_G,         /*!<Assigs 5 to the keyword "TAKE_G", which representes taking the grain object*/   
    TAKE_C,         /*!<Assigs 6 to the keyword "TAKE_C", which representes taking the crumb object**/   
    TAKE_L,         /*!<Assigs 7 to the keyword "TAKE_L", which representes taking the leaf object**/              
    DROP,           /*!<Assigs 8 to the keyword "DROP", which will be used in command-related functions*/      
    CHAT            /*!<Assigs 9 to the keyword "DROP", which will be used in command-related functions*/  
} CommandCode;
